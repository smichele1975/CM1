...
static void event_handler_cb_main_setting_btn(lv_event_t *e) {
...
static void event_handler_cb_settings_cancel_btn(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_settings_save_btn(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_settings_wifi_tab(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_settings_password_text_area(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
void create_screen_main() {
    ...
    lv_obj_set_size(obj, 1024, 600);
    {
        ...
        }
        {
            // label_bar
            lv_obj_t *obj = lv_obj_create(parent_obj);
            objects.label_bar = obj;
            lv_obj_set_pos(obj, 0, 576);
            ...
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_set_pos(obj, 27430, 0);
                    lv_obj_set_size(obj, 1022, LV_SIZE_CONTENT);
                    lv_obj_set_style_width(obj, 1024, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_text_align(obj, LV_TEXT_ALIGN_RIGHT, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_label_set_text_static(obj, "CM version 0.1 alpha");
                }
            }
        }
    }
    ...
    lv_obj_set_size(obj, 1024, 600);
    {
        ...
        }
        {
            ...
            add_style_bar_style(obj);
            {
                ...
                {
                    lv_obj_t *obj = lv_obj_create(parent_obj);
                    lv_obj_set_pos(obj, 0, 5092);
                    lv_obj_set_size(obj, 300, 52);
                    lv_obj_set_style_pad_left(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_pad_top(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_pad_right(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_pad_bottom(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
                    ...
                    lv_obj_set_style_pad_column(obj, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
                            ...
                            lv_obj_add_event_cb(obj, event_handler_cb_settings_cancel_btn, LV_EVENT_ALL, flowState);
                            add_style_button_style(obj);
                            lv_obj_set_style_bg_color(obj, lv_color_hex(0xcd5c5c), LV_PART_MAIN | LV_STATE_DEFAULT);
                            {
                                lv_obj_t *parent_obj = obj;
                                {
                                    lv_obj_t *obj = lv_label_create(parent_obj);
                        ...
                        }
                        {
                            ...
                            lv_obj_set_pos(obj, 0, 0);
                            lv_obj_set_size(obj, 110, 48);
                            lv_obj_add_event_cb(obj, event_handler_cb_settings_save_btn, LV_EVENT_ALL, flowState);
                            add_style_button_style(obj);
                            lv_obj_set_style_bg_color(obj, lv_color_hex(0x2e8b57), LV_PART_MAIN | LV_STATE_DEFAULT);
                            {
                                lv_obj_t *parent_obj = obj;
                                {
                                    lv_obj_t *obj = lv_label_create(parent_obj);
        ...
        }
        {
            ...
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    // version_label_1
                    lv_obj_t *obj = lv_label_create(parent_obj);
                    objects.version_label_1 = obj;
                    lv_obj_set_pos(obj, 27430, 0);
                    lv_obj_set_size(obj, 1022, LV_SIZE_CONTENT);
                    lv_obj_set_style_width(obj, 1024, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_text_align(obj, LV_TEXT_ALIGN_RIGHT, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_label_set_text_static(obj, "System setting page");
                }
            }
        }
        {
                ...
                }
                {
                    ...
                    lv_obj_set_scroll_dir(obj, LV_DIR_NONE);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
                            ...
                            lv_obj_add_event_cb(obj, event_handler_cb_settings_wifi_tab, LV_EVENT_ALL, flowState);
